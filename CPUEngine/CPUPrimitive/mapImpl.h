...
template <class T> void mapImpl_thread(Record *Rin, int rLen, mapper_t mapFunc, void* para, T* Rout, int numThread)
{
	int result=0;
...
//open mp versions.
template <class T> void mapImpl_openmp(Record *Rin, int rLen, mapper_t mapFunc, void* para, T* Rout)
{
	int i=0;
