...
int smj_omp(Record *R, int rLen, Record *S, int sLen, Record** Rout, int numThread);
int hj_omp(Record *R, int rLen, Record *S, int sLen, Record** Rout, int numThread);
int MergeJoinSortedRelation_omp(Record *R, int rLen, Record *S, int sLen, Record** Rout, int numThread);
